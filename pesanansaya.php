...
<head>
    ...
    <link rel="stylesheet" href="css/styletoko.css">
...
<body>
    ...
    <header>
        ...
        <a href="#" class="logo"><i class="fas fa-tshirt"></i>Zigma Konveksi</a>
        ...
        <nav class="navbar">
            ...
            <a href="pemesanan.php">pesan</a>
            <a href="tespesanan.php">pesanan saya</a>
        </nav>
        ...
        <div class="swiper-container home-slider">
            ...
            <div class="swiper-wrapper wrapper">
                ...
                <div class="swiper-slide slide">
                    <div class="content">
                        <span>Desain Terbaru</span>
                        <h3>Nama Baju</h3>
                        <p>Limited Edition <i class="fas fa-fire"></i></p>
    ...
    <section class="discc" id="discc">

        <h3 class="sub-heading"> Produk Kami </h3>
        <h1 class="heading"> Produk Populer </h1>
    ...
    <section class="about" id="about">
        ...
        <h1 class="heading"> Bagaimana Menurut anda? </h1>
    ...
    <section class="menu" id="menu">
        ...
        <h3 class="sub-heading"> Produk kami </h3>
        <h1 class="heading"> Pesanan terbanyak </h1>

        <div class="box-container">

            <div class="box">
                <div class="image">
                    <img src="images/celana.png" alt="">
                    <a href="#" class="fas fa-heart"></a>
                </div>
                <div class="content">
                    <div class="stars">
    ...
    <section class="review" id="review">
        ...
        <h3 class="sub-heading"> review customer </h3>
        <h1 class="heading"> ulasan mereka </h1>
    ...
    <section class="footer">
        ...
        <div class="credit"> &copy; copyright 2O22 by <span>M Agung Pambudi</span> </div>
